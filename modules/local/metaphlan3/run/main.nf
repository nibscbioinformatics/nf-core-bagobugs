...
process METAPHLAN3_RUN {
    ...
    def input_type = ("$input".contains(".fastq")) ? "--input_type fastq" :  ("$input".contains(".fasta")) ? "--input_type fasta" : ("$input".endsWith(".fna")) ? "--input_type fasta" : ("$input".endsWith(".bowtie2out.txt")) ? "--input_type bowtie2out" : "--input_type sam" //last part necessary to work with samtools_view module output (methaphlan won't accept bam files..)
